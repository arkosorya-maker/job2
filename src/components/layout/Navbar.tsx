      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6">
            <Link to={user?.role === 'admin' ? "/admin" : "/login"} className="text-sm font-bold text-amber-600 hover:text-amber-700 transition-colors bg-amber-50 px-3 py-1 rounded-full border border-amber-200">
              {t('admin_panel')}
            </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          {!user ? (
            ...
            <div className="flex items-center gap-4 pl-4 border-l border-gray-200">
              ...
              <Button variant="ghost" size="icon" onClick={handleLogout} className="text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-full">
